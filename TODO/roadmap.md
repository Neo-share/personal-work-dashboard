...
> `TODO/` 目录的索引与依赖关系。实现状态见 [IMPLEMENTATION_STATUS.md](../IMPLEMENTATION_STATUS.md)；全项目文档索引见 [AGENTS.md §2.1](../AGENTS.md#21-文档对照表)。
...
| **docs/个人工作台/个人工作台-功能点.md** | L4 **产品功能点与完成状态** | `IMPLEMENTATION_STATUS` §13 · `个人工作台-技术功能点` |
...
| **guardrail-enhancement.md** | 四层护栏**规则细则**与验收场景 | `ARCHITECTURE.md` §3.3 |
